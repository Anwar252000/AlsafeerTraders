...
import ClientApi, { useAddClientMutation } from '../../services/apis/Client';
...
function AddClient() {
    ...
    const {data: clientList} = useGetClientTypeListQuery();
    ...
    const onSubmit = async (formData) => {
        try {
            const payload = {
                ...
                clientTypeId: formData.clientList?.clientTypeId || formData.clientTypeId
            };
                                ...
                                <div className="card-body pt-1">
                                    <ul className="nav nav-tabs nav-tabs-bordered">
                                        <li className="nav-item">
                                            <button className="nav-link active" data-bs-toggle="tab" data-bs-target="#std-details">Fill In Client's Details</button>
                                        </li>
                                    </ul>
