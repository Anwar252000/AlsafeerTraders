...
const DataTable = ({ title, data = [], columns, onUpdate, onDelete, EditModal }) => {
  ...
  const handleUpdateSubmit = (updatedData) => {
    // Ensure clientId and clientTypeId are included in updated data
    const finalUpdatedData = {
      ...selectedRowData,   // Include original row data as a base
      ...updatedData,       // Override with any changed values from modal
    };
    onUpdate(finalUpdatedData);     // Pass updated data to onUpdate callback
    handleCloseModal();
  };
